...
class CategoryEntitySerializer(serializers.ModelSerializer[Any]):
...
class CategoryListSerializer(serializers.ModelSerializer[Any]):
...
class CategoryCreateSerializer(serializers.ModelSerializer[Any]):
...
class CategoryUpdateSerializer(serializers.ModelSerializer[Any]):
    models = CategoryEntitySerializer(many=True)
