...
describe("useJobCompletionNotification", () => {
  ...
  test("should show toast when a new job reaches terminal status after first load", () => {
    const initialJobs = [
      makeJob({ id: 1, status: JobStatuses.PROCESSING }),
    ];
  ...
  test("should skip non-terminal jobs", () => {
    const initialJobs = [
      makeJob({ id: 10, status: JobStatuses.PREPARING }),
    ];
  ...
  test("should handle ERROR status job", () => {
    const initialJobs = [
      makeJob({ id: 7, status: JobStatuses.PROCESSING }),
    ];
  ...
  test("should handle TIMEOUT status job", () => {
    const initialJobs = [
      makeJob({ id: 8, status: JobStatuses.PROCESSING }),
    ];
